  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      final touchpoint = Touchpoint(
        ...
        touchpointNumber: widget.touchpointNumber,
        type: widget.touchpointType == 'Visit' ? TouchpointType.visit : TouchpointType.call,
        date: DateTime.now(),
        createdAt: DateTime.now(),
        reason: TouchpointReason.fromApi(state.reason!),
        status: _selectedStatus == 'Interested'
            ? TouchpointStatus.interested
            : _selectedStatus == 'Undecided'
                ? TouchpointStatus.undecided
                : _selectedStatus == 'Not Interested'
                    ? TouchpointStatus.notInterested
                    : TouchpointStatus.completed,
        remarks: _remarksController.text.trim(),
        timeIn: state.timeIn.time,
      ...
      final touchpointCreationService = ref.read(touchpointCreationServiceProvider);
      await touchpointCreationService.createTouchpoint(
        widget.clientId,
        touchpoint,
