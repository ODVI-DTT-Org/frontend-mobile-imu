...
class _ClientDetailPageState extends ConsumerState<ClientDetailPage> {
      ...
      body: Column(
        children: [
          ...
          Expanded(
            ...
            if (_hasLegacyFields()) ...[
              _Section(title: 'Legacy PCNICMS Information'),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16),
                child: Column(
                  children: [
                    // Name Fields
                    if (_client!.extName != null)
                      _InfoRow(
                        icon: LucideIcons.user,
                        label: 'Extension Name',
                        value: _client!.extName!,
                      ),
                    ...
                    // Account Fields
                    if (_client!.accountCode != null)
                      _InfoRow(
                        icon: LucideIcons.key,
                        label: 'Account Code',
                        value: _client!.accountCode!,
                      ),
                    if (_client!.accountNumber != null)
                      _InfoRow(
                        icon: LucideIcons.hash,
                        label: 'Account Number',
                        value: _client!.accountNumber!,
                      ),
                    // Rank & Status
                    if (_client!.rank != null)
                      _InfoRow(
                        icon: LucideIcons.shield,
                        label: 'Rank',
                        value: _client!.rank!,
                      ),
                    if (_client!.gCompany != null)
                      _InfoRow(
                        icon: LucideIcons.building,
                        label: 'Company',
                        value: _client!.gCompany!,
                      ),
                    if (_client!.gStatus != null)
                      _InfoRow(
                        icon: LucideIcons.activity,
                        label: 'Group Status',
                        value: _client!.gStatus!,
                      ),
                    // Pension Amounts
                    if (_client!.monthlyPensionAmount != null)
                      _InfoRow(
                        icon: LucideIcons.dollarSign,
                        label: 'Monthly Pension (Net)',
                        value: _formatCurrency(_client!.monthlyPensionAmount!),
                      ),
                    if (_client!.monthlyPensionGross != null)
                      _InfoRow(
                        icon: LucideIcons.dollarSign,
                        label: 'Monthly Pension (Gross)',
                        value: _formatCurrency(_client!.monthlyPensionGross!),
                      ),
                    // Other Fields
                    if (_client!.atmNumber != null)
                      _InfoRow(
                        icon: LucideIcons.creditCard,
                        label: 'ATM Number',
                        value: _client!.atmNumber!,
                      ),
                    if (_client!.applicableRepublicAct != null)
                      _InfoRow(
                        icon: LucideIcons.fileText,
                        label: 'Republic Act',
                        value: _client!.applicableRepublicAct!,
                      ),
                    if (_client!.unitCode != null)
                      _InfoRow(
                        icon: LucideIcons.map,
                        label: 'Unit Code',
                        value: _client!.unitCode!,
                      ),
                    if (_client!.pcniAcctCode != null)
                      _InfoRow(
                        icon: LucideIcons.keyRound,
                        label: 'PCNI Account Code',
                        value: _client!.pcniAcctCode!,
                      ),
                    if (_client!.dob != null)
                      _InfoRow(
                        icon: LucideIcons.cake,
                    ...
                    if (_client!.fullAddress != null)
                      _InfoRow(
                        icon: LucideIcons.mapPin,
                        label: 'Full Address',
                        value: _client!.fullAddress!,
                      ),
                    // Status Field
                    if (_client!.status != null && _client!.status != 'active')
                      _InfoRow(
  ...
  // Check if client has any legacy PCNICMS fields
  bool _hasLegacyFields() {
    return _client!.extName != null ||
        _client!.fullname != null ||
        _client!.fullAddress != null ||
        _client!.accountCode != null ||
        _client!.accountNumber != null ||
        _client!.rank != null ||
        _client!.monthlyPensionAmount != null ||
        _client!.monthlyPensionGross != null ||
        _client!.atmNumber != null ||
        _client!.applicableRepublicAct != null ||
        _client!.unitCode != null ||
        _client!.pcniAcctCode != null ||
        _client!.dob != null ||
        _client!.gCompany != null ||
        _client!.gStatus != null ||
        _client!.status != null;
  }

  // Format numeric value as currency (Philippine Peso)
